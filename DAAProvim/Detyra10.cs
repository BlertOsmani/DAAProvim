...
//         Console.WriteLine(parser.CountOfAtoms("H2O"));          // Output: "H2O"
//         Console.WriteLine(parser.CountOfAtoms("Mg(OH)2"));      // Output: "H2MgO2"
//         Console.WriteLine(parser.CountOfAtoms("K4(ON(SO3)2)2"));// Output: "K4N2O14S4"
//     }
// }
...
//             if (formula[i] == '(')
//             {
//                 // Push the current dictionary onto the stack and create a new one
//                 stack.Push(current);
